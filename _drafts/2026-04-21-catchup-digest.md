...
This is an active build, not a finished product. I am writing about it because the problem is personal and the shape is clear enough to share: aggregate, summarize, deliver on my clock. If you live in newsletter debt too, that is the itch.
