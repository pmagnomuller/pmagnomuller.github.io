...
The wider catalog — battery arbitrage, heat-pump load shift, carbon-intensity scheduling — lives in a skills library I keep locally. OpenClaw gets the automation surface. Cursor, Claude Code, and Codex get the same recipes when I am writing instead of chatting from the couch.
