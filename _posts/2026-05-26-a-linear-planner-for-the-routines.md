...
Nothing fancy. Linear stays the source of truth. The planner is a short list I maintain: tickets I have marked as fair game for agent work. A routine — the same ticket-to-PR loop from the talk: read the issue, look at the repo, implement, open a PR — only starts if the ticket is on that list. If it isn't, it waits. That sounds obvious. It is also the difference between "AI is helping" and "AI opened three PRs I now have to unwind."
